...
export default function Header() {
  ...
  return (
    <header className="bg-brutal-white sticky top-0 z-50 border-b-[4px] border-brutal-black">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Link to="/diary/new">
            <button className="bg-primary brutal-border px-4 py-2 font-black text-sm cursor-pointer hover:bg-primary/80 transition-colors brutal-shadow rounded-lg">
              写一篇
            </button>
          </Link>
        </div>
